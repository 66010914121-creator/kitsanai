...
<head>
    ...
    <title>ใบสมัครงาน - บริษัท กฤษนัย จำกัด</title>
    ...
    <style>
        :root {
            --primary-color: #35FF89FF;
            --secondary-color: #6c757d;
            --accent-color: #007DE4FF;
            --light-bg: #f8f9fa;
        }
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-10">
                    ...
                    <p class="subtitle">บริษัท กฤษนัย จำกัด - สมัครงานกับเราและร่วมเป็นส่วนหนึ่งของทีมเทคโนโลยีชั้นนำ</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <!-- Footer -->
        <div class="footer">
            <p><i class="fas fa-phone me-1"></i> โทรศัพท์:0842756334 | <i class="fas fa-envelope me-1"></i> อีเมล: 66010914121@mau.ac.th</p>
            <p class="mt-3">© 2023 บริษัท กฤษนัย จำกัด. สงวนลิขสิทธิ์.</p>
        </div>
    </div>
    ...
    <?php
        if(isset($_POST['Submit'])){
            ...
            VALUES (NULL,'{$title}', '{$fullname}' ,'{$birthday}','{$education}'
            ,'{$position}','{$skill}','{$experience}');";
