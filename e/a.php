...
<head>
    ...
    <title>กฤษนัย สรพิมพ์ (ไกด์) 66010914121</title>
    ...
    <style>
        .header-title {
            ...
            padding-bottom: 10px;
            border-bottom: 2px solid #6235DCFF;
            margin-bottom: 25px;
        }
...
<body>
    <div class="container mt-4 mb-5">
        ...
        <div class="text-center mb-4">
            ...
            <p class="lead text-muted">กฤษนัย สรพิมพ์ (ไกด์) รหัส 66010914121</p>
        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>แบบฟอร์มนี้พัฒนาโดย กฤนัย สรพิมพ์ (ไกด์) รหัส 66010914121</p>
